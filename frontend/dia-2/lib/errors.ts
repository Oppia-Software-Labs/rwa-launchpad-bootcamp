/** Contract Error enum from dia-2/src/lib.rs */
...
const MESSAGES: Record<ContractErrorCode, string> = {
  ...
  [ContractErrorCode.InvalidAmount]:
    "Invalid amount. Amounts must be greater than zero.",
  [ContractErrorCode.NotWhitelisted]:
    "This wallet is not whitelisted. Ask an admin to approve your address.",
  [ContractErrorCode.Paused]:
    "The launchpad is paused. Mint and transfer are disabled until it is unpaused.",
};
